...
const servicePages = [
  ...
  { path: '/services/wett',            title: 'WETT Inspection Ontario | Insurance Certificate | ASADS',              desc: 'Certified WETT inspection for fireplaces, wood stoves & inserts in Ontario. Insurance-approved certificates. Thermal imaging included. From $249.' },
