...
const servicePages = [
  ...
  { path: '/services/asbestos-testing',title: 'Asbestos Testing Ontario | Accredited Lab | ASADS',                   desc: 'Certified asbestos testing Ontario from $299. Bulk sampling, O.Reg 278/05 compliance, AIHA lab results. Residential & commercial. Call (647) 801-9311.' },
  ...
  { path: '/services/sewer-scope',     title: 'Sewer Scope Inspection Ontario | From $299 | ASADS',                 desc: 'Sewer scope from $299. CCTV drain camera finds root intrusion, pipe bellies & cracks before you buy. GPS mapping, same-day video report. GTA & Ontario.' },
