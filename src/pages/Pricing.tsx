...
const mainInspections = [
  {
    ...
    features: [
      ...
      "4.9★ rated across 1,500+ verified reviews",
    ],
          ...
          <div className="max-w-4xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="flex items-center gap-2 mb-5">
                {[1,2,3,4,5].map(i => (
                  <svg key={i} className="h-6 w-6 fill-yellow-400 text-yellow-400" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/></svg>
                ))}
                <span className="text-white font-bold text-xl ml-1">4.9</span>
                <span className="text-blue-200 text-sm ml-1">· 1,500+ verified reviews</span>
              </div>
              <h2 className="text-3xl font-bold mb-4">Ready to Book Your Inspection?</h2>
              <p className="text-blue-100 text-lg mb-6 leading-relaxed">
                Ontario's most-reviewed home inspection team. Same-day reports, 106 cities, 7 days a week.
              </p>
