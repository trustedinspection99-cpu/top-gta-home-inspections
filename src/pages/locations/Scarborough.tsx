...
// Primary keyword: "home inspection scarborough"
// Secondary keywords: "home inspection scarborough ontario", "home inspection east toronto", "scarborough home inspectors"
const primaryKeyword = "home inspection scarborough";
const secondaryKeywords = [
  "home inspection scarborough ontario",
  "home inspection east toronto", 
  "scarborough home inspectors",
  "home inspection toronto scarborough",
  "scarborough ontario home inspection"
];
...
const allServices = [
  { 
    ...
    description: "Complete evaluation before buying a property in Scarborough",
  ...
  { 
    ...
    href: "/services/condo",
    description: "Specialized condo inspections in Scarborough high-rises and apartments",
    icon: <Building className="h-6 w-6" />,
    anchorText: "condo inspection Scarborough"
  },
  { 
    title: "New Construction Inspection", 
    href: "/services/new-construction",
    description: "Phase and final inspections for newly built Scarborough homes",
  ...
  { 
    ...
    description: "Home inspection before selling your Scarborough property",
  ...
  { 
    ...
    description: "Commercial property inspections throughout Scarborough",
    icon: <Building className="h-6 w-6" />,
    anchorText: "commercial property inspection Scarborough"
  },
  { 
    title: "Radon Testing", 
    href: "/services/radon-testing",
    description: "Radon gas testing for Scarborough homes and basements",
    icon: <Wind className="h-6 w-6" />,
    anchorText: "radon testing in Scarborough"
  },
  { 
    title: "Mold Inspection", 
    href: "/services/mold-inspection",
    description: "Professional mold inspection and testing in Scarborough",
    icon: <Droplets className="h-6 w-6" />,
    anchorText: "mold inspection Scarborough"
  },
  { 
    title: "Thermal Imaging", 
    href: "/services/thermal-imaging",
    description: "Infrared thermal imaging inspections for Scarborough properties",
    icon: <Camera className="h-6 w-6" />,
    anchorText: "thermal imaging inspection Scarborough"
  },
  { 
    title: "WETT Inspection", 
    href: "/services/wett",
    description: "WETT-certified inspections for wood-burning appliances in Scarborough",
    icon: <Flame className="h-6 w-6" />,
    anchorText: "WETT inspection Scarborough"
  },
  { 
    title: "Sewer Scope Inspection", 
    href: "/services/sewer-scope",
    description: "Camera sewer line inspections for Scarborough homes",
    icon: <Video className="h-6 w-6" />,
    anchorText: "sewer scope inspection Scarborough"
  },
  { 
    title: "Asbestos Testing", 
    href: "/services/asbestos-testing",
    description: "Asbestos testing for older Scarborough homes",
    icon: <Biohazard className="h-6 w-6" />,
    anchorText: "asbestos testing Scarborough"
  },
  { 
    title: "Lead Paint Testing", 
    href: "/services/lead-paint-testing",
    description: "Lead-based paint testing for Scarborough properties",
    icon: <PaintBucket className="h-6 w-6" />,
    anchorText: "lead paint testing Scarborough"
  },
  { 
    title: "Air Quality Testing", 
    href: "/services/air-quality",
    description: "Indoor air quality testing in Scarborough homes",
    icon: <WindIcon className="h-6 w-6" />,
    anchorText: "air quality testing Scarborough"
  },
  { 
    title: "Well Water Testing", 
    href: "/services/well-water-testing",
    description: "Well water quality testing for properties near Scarborough",
    icon: <Droplet className="h-6 w-6" />,
    anchorText: "well water testing Scarborough"
  }
];

// Scarborough neighborhoods - NO LINKS, just display
const scarboroughNeighborhoods = [
  { name: "Scarborough City Centre", service: "Home Inspection" },
  { name: "Agincourt", service: "Home Inspection" },
  { name: "Birch Cliff", service: "Home Inspection" },
  { name: "Cliffside", service: "Home Inspection" },
  { name: "Cliffcrest", service: "Home Inspection" },
  { name: "Guildwood", service: "Home Inspection" },
  { name: "Highland Creek", service: "Home Inspection" },
  { name: "L'Amoreaux", service: "Home Inspection" },
  { name: "Morningside", service: "Home Inspection" },
  { name: "Rouge", service: "Home Inspection" },
  { name: "Scarborough Village", service: "Home Inspection" },
  { name: "West Hill", service: "Home Inspection" },
  { name: "Wexford", service: "Home Inspection" },
  { name: "Woburn", service: "Home Inspection" },
  { name: "Malvern", service: "Home Inspection" },
  { name: "Milliken", service: "Home Inspection" }
];
...
const expertisePoints = [
  ...
  "12+ Years Scarborough Home Inspection Experience",
  "Scarborough Building Code Specialists",
...
const faqs = [
  ...
  },
  {
    ...
    answer: `Yes, we strongly recommend attending your <strong>Scarborough home inspection</strong>. This allows you to walk through the property with our inspector, ask questions in real-time, learn about maintenance requirements, and understand the significance of any issues discovered. We provide valuable insights about your specific Scarborough home that you won't get from just reading the report.`
  },
  {
    question: "What are the most common issues found in Scarborough home inspections?",
    answer: `Common issues in <strong>Scarborough homes</strong> include: roofing problems (especially with older asphalt shingles), foundation cracks due to Toronto's clay soil, outdated electrical panels (Federal Pacific, Zinsco), knob and tube wiring in pre-1960 homes, galvanized plumbing in mid-century homes, inadequate attic ventilation, basement moisture issues, and aging HVAC systems exceeding their service life.`
  },
  {
    question: "How soon will I receive my inspection report in Scarborough?",
    answer: `We provide <strong>same-day digital reports</strong> for all Scarborough home inspections. You'll receive your comprehensive inspection report via email within 4-6 hours of completing the inspection. Reports include detailed findings, high-resolution photos, maintenance recommendations, and prioritized repair suggestions to help you make informed decisions about your Scarborough property.`
  },
  {
    question: "Do you inspect condos and high-rises in Scarborough?",
    answer: `Yes, we specialize in <Link to="/services/condo">condo inspections in Scarborough</Link>. Our condo inspections focus on the unit's interior systems including HVAC units, electrical panels, plumbing fixtures, windows, balconies, and interior finishes. We also help you understand building Status Certificates and reserve fund studies, which are crucial for Scarborough's condo market.`
  },
  {
    question: "What areas of Scarborough do you service?",
    answer: `We provide <strong>home inspection services throughout Scarborough</strong> including Scarborough City Centre, Agincourt, Birch Cliff, Cliffside, Guildwood, and all surrounding neighborhoods. We also serve the entire Greater Toronto Area including Toronto, Markham, Pickering, Ajax, and beyond.`
  }
];
...
const testimonials = [
  {
    name: "Michael Chen",
    location: "Scarborough City Centre",
    content: "The ASADS home inspection in Scarborough was incredibly thorough. The inspector spent over 3 hours examining every detail of our potential home and identified several issues we would have missed. The same-day report helped us negotiate $15,000 in repairs. Highly recommend for any Scarborough home buyer!",
    rating: 5
  },
  {
    name: "Sarah Thompson",
    location: "Guildwood, Scarborough",
    content: "As first-time home buyers in Scarborough, we were nervous about the inspection process. ASADS made it easy to understand and provided exceptional service. Their Scarborough-specific knowledge of heritage homes was invaluable. The detailed report gave us complete confidence in our purchase.",
    rating: 5
  },
  {
    name: "David Wilson",
    location: "Agincourt, Scarborough",
    content: "We've used ASADS for multiple property inspections in Scarborough. Their attention to detail is unmatched, especially with older Scarborough homes. The thermal imaging service identified hidden moisture issues that saved us from a major repair down the line. Professional, knowledgeable, and worth every penny.",
    rating: 5
  }
];
...
export default function Scarborough() {
  ...
  const localBusinessSchema = {
    ...
    "@type": "LocalBusiness",
    "name": "ASADS Home Inspection Scarborough",
    "description": "Professional home inspection services in Scarborough providing comprehensive property assessments, condo inspections, and specialized testing services throughout Scarborough and the Greater Toronto Area.",
    "url": pageUrl,
    "telephone": "+16478019311",
    "email": "scarborough@asads.ca",
    "address": {
      "@type": "PostalAddress",
    ...
    "priceRange": "$$",
    "image": `${SITE_URL}/images/scarborough-home-inspection.jpg`,
    "aggregateRating": {
  ...
  const serviceSchema = {
    ...
    "hasOfferCatalog": {
      "@type": "OfferCatalog",
      "name": "Scarborough Home Inspection Services",
    ...
    "description": "Professional home inspection services in Scarborough including pre-purchase inspections, condo inspections, new construction inspections, radon testing, mold inspection, thermal imaging, and specialized property assessments."
  };
  ...
  return (
    <Layout>
      <Helmet>
        ...
        <meta name="keywords" content={`${primaryKeyword}, ${secondaryKeywords.join(", ")}, home inspectors scarborough, property inspection scarborough`} />
        ...
        <meta property="og:image" content={`${SITE_URL}/images/og-scarborough-home-inspection.jpg`} />
        ...
        <meta name="twitter:image" content={`${SITE_URL}/images/twitter-scarborough-home-inspection.jpg`} />
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-wrap gap-4 mb-8 justify-center">
              ...
              <div className="flex items-center gap-2 bg-primary-foreground/15 px-4 py-3 rounded-xl">
                ...
                <span>Licensed Scarborough Inspectors</span>
              </div>
            </div>
      ...
      {/* Scarborough Home Inspection Content - SEO Optimized */}
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="mb-16">
              <div className="prose prose-lg max-w-none">
                <p className="text-lg text-muted-foreground mb-6">
                  When searching for <strong>home inspection companies in Scarborough</strong>, choosing licensed professionals with local expertise is essential for protecting your investment. ASADS Home Inspection provides comprehensive property assessments throughout Toronto's east end, helping homeowners, buyers, and sellers make informed decisions with confidence.
                </p>
                
                <h2 className="font-heading text-3xl font-bold text-foreground mb-6">
                  Comprehensive Home Inspection Services in Scarborough
                </h2>
                
                <p className="text-muted-foreground mb-6">
                  Our <Link to="/services/pre-purchase" className="text-primary hover:underline font-medium">pre-purchase home inspection in Scarborough</Link> is designed to identify both obvious defects and hidden problems that could cost thousands in repairs. From foundation assessments to roofing evaluations, our licensed inspectors examine every accessible component of your property following Ontario's Standards of Practice.
                </p>
                  ...
                  <div key={index} className="flex items-start gap-4 p-5 bg-card rounded-xl border border-border hover:border-primary/30 transition-colors">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Thorough evaluation and detailed reporting of this critical component in your Scarborough property.
                      </p>
                    </div>
                  </div>
                ))}
            ...
            <div className="mb-16">
              <div className="text-center mb-10">
                <h2 className="font-heading text-3xl font-bold text-foreground mb-4">
                  14+ Professional Home Inspection Services in Scarborough
                </h2>
                <p className="text-muted-foreground max-w-3xl mx-auto">
                  Comprehensive inspection solutions for every Scarborough property type and concern. Each service includes detailed reporting, expert analysis, and professional recommendations.
                </p>
              </div>
            ...
            <div className="mb-16">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-3">
                {scarboroughNeighborhoods.map((hood, index) => (
                  <div
                    key={index}
              ...
              <div className="text-center mt-8">
                <p className="text-muted-foreground">
                  Also serving all GTA communities including Toronto, Markham, Pickering, Ajax, and beyond.
                </p>
              </div>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-xl text-muted-foreground mb-8 max-w-3xl mx-auto">
                Book your comprehensive home inspection in Scarborough today. Our licensed inspectors provide detailed assessments with same-day reports, competitive pricing, and professional service throughout Toronto's east end.
              </p>
