...
const metaDescription = "Looking for comprehensive home inspection in East York? ASADS provides professional home inspection services with licensed inspectors, same-day reports, and competitive pricing starting at $350. Serving East York, Leaside, Don Mills, and all Toronto neighborhoods.";
        ...
        <div className="container">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-primary-foreground/90 mb-8 max-w-3xl mx-auto">
              Looking for comprehensive <strong>home inspection in East York</strong>? ASADS provides professional property assessments with licensed inspectors, same-day digital reports, and competitive pricing starting at $350. Serving all East York neighborhoods and GTA communities.
            </p>
