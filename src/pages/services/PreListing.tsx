...
export default function PreListing() {
  ...
  return (
    <ServicePageTemplate
      ...
      faqs={[
        {
          question: "Why should Toronto sellers get a pre-listing inspection?",
          answer: "It eliminates 11th-hour surprises. By identifying issues like knob-and-tube wiring or foundation cracks early, you can fix them on your own terms or disclose them to prevent buyers from 'chipping' away at your price."
        },
        {
          question: "Does this help with my Seller Property Information Statement (SPIS)?",
          answer: "Absolutely. Our report provides the technical documentation you need to accurately fill out your disclosure forms, protecting you from future legal liability."
        },
        {
          question: "How does this differ from a buyer's pre-purchase inspection?",
          answer: "While buyers typically book a Pre-Purchase Home Inspection, sellers can proactively use a pre-listing inspection to reduce negotiations and speed up the sale by addressing issues before listing."
        },
        {
          question: "How much does a pre-listing inspection cost in Toronto?",
          answer: "Pre-listing inspection pricing depends on property size. Contact us at (647) 801-9311 for a personalized quote. The investment typically pays for itself through faster sales and reduced price negotiations."
        },
        {
          question: "Can I share the inspection report with potential buyers?",
          answer: "Yes. Our Marketing-Ready PDF reports are designed specifically to be shared with buyers and realtors, building confidence and encouraging unconditional offers."
        },
      ]}
      relatedServices={[
