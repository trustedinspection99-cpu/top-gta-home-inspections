  ...
  return (
    <ServicePageTemplate
      ...
      faqs={[
        ...
        {
          question: "What types of commercial properties do you inspect in Toronto?",
          answer: "We inspect all commercial asset classes including industrial warehouses, retail plazas, office buildings, multi-family residential, mixed-use developments, and hospitality properties across the GTA."
        },
      ]}
      relatedServices={[
