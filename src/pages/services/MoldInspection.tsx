        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <div className="space-y-4">
              {[
                {
                  city: "Mold Inspection — Toronto",
                  body: "Toronto's pre-war and post-war housing stock — spanning The Annex, Rosedale, Leslieville, East York, Leaside, and Danforth — presents some of Ontario's highest mold risk by building age. Century homes from the 1880s through 1920s have solid masonry walls that retain moisture, original single-pane windows that create heavy condensation in winter, and plaster-and-lathe wall systems that absorb and hold water from envelope leaks for months before visible mold appears. Post-war bungalows in Swansea, High Park, and Weston commonly have unventilated or poorly ventilated attic spaces where decades of bathroom fan exhaust have created black and grey mold colonies on roof sheathing. Downtown Toronto condo units in older buildings along the Yonge corridor and in Liberty Village present fan coil moisture problems and balcony door air leakage as recurring mold triggers. ASADS provides certified mold inspection and air sampling across all Toronto neighbourhoods with same-day scheduling.",
                },
                {
                  city: "Mold Inspection — Etobicoke",
                  body: "Etobicoke's post-war residential stock — particularly bungalows and split-levels in Islington, Rexdale, Alderwood, Long Branch, and Mimico built between 1950 and 1975 — is at peak age for attic mold from bathroom fan exhaust routed into attic spaces rather than to the exterior. This code violation was standard practice in this era and affects the majority of Etobicoke's original bungalow stock. The result is moisture accumulation on roof sheathing that progresses from staining to active mold colonization over years without visible interior symptoms. Etobicoke's proximity to Lake Ontario also elevates ambient relative humidity, accelerating mold growth in under-insulated wall cavities and unheated crawl spaces. Kingsway and Humber Valley heritage homes present moisture infiltration through original stone and brick foundation walls. ASADS provides certified mold testing throughout Etobicoke with same-day availability.",
                },
                {
                  city: "Mold Inspection — North York & Scarborough",
                  body: "North York and Scarborough contain the GTA's largest inventory of 1960s and 1970s apartment towers and bungalow subdivisions where mold inspection is increasingly common as buildings age. North York towers along Yonge Street, the Sheppard corridor, and in Willowdale frequently present lobby and unit mold from chronic envelope water infiltration through aging window seals, concrete balcony cracks, and deteriorated building envelope membranes. Scarborough's bungalow stock in Birchcliffe, Cliffside, and West Hill — many built in the 1950s — commonly has knob-and-tube electrical in walls that complicates renovation access and prolongs moisture exposure in wall cavities with suspected mold. Agincourt and Milliken's high-density townhouse developments from the 1980s and 1990s present attic mold from inadequate soffit ventilation and improperly terminated bath fan exhaust. ASADS provides full mold inspection and AIHA-certified lab sampling across North York and Scarborough with same-day booking.",
                },
                {
