...
export default function ThermalImaging() {
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "Can thermal imaging see 'through' walls?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Not exactly. It detects surface temperature variations. Changes caused by moisture, missing insulation, or hidden electrical faults allow us to visualize hidden issues behind walls, ceilings, and floors."
        }
      },
      {
        "@type": "Question",
        "name": "Is thermal imaging included in a standard inspection?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Yes. At ASADS, thermal scanning is integrated as a standard add-on for pre-purchase or pre-listing inspections to ensure hidden defects are identified before closing."
        }
      },
      {
        "@type": "Question",
        "name": "Can thermal imaging detect mold?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Thermal imaging identifies moisture intrusion that may lead to mold growth. While it cannot detect spores directly, it helps pinpoint areas at risk, ensuring remediation addresses the source."
        }
      },
      {
        "@type": "Question",
        "name": "Why hire a certified thermographer?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Certified thermographers understand thermal physics, emissivity, and infrared interpretation. This ensures accurate detection of leaks, insulation gaps, and electrical hotspots, avoiding false positives."
        }
      }
    ]
  };
