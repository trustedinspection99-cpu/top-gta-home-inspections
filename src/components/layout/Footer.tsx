        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-5">
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-4">
              ...
              <a href="https://www.instagram.com/asads_home_inspection?igsh=MWExbmpseWNsd3Voaw==" target="_blank" rel="noopener noreferrer" className="hover:text-accent transition-colors" aria-label="Instagram">
              ...
              <a href="https://youtube.com/@asadshomeinspection?si=YldymXwWf-D8IEW4" target="_blank" rel="noopener noreferrer" className="hover:text-accent transition-colors" aria-label="YouTube">
              ...
              <a href="https://www.tiktok.com/@asads_home_inspection" target="_blank" rel="noopener noreferrer" className="hover:text-accent transition-colors" aria-label="TikTok">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                <Phone className="h-5 w-5 mt-0.5 text-accent" aria-hidden="true" />
                <a href="tel:+16478019311" className="text-sm hover:text-accent transition-colors">(647) 801-9311</a>
              </li>
              <li className="flex items-start gap-3">
                <Mail className="h-5 w-5 mt-0.5 text-accent" aria-hidden="true" />
                <a href="mailto:info@asads.ca" className="text-sm hover:text-accent transition-colors">info@asads.ca</a>
              </li>
              <li className="flex items-start gap-3">
                <Clock className="h-5 w-5 mt-0.5 text-accent" aria-hidden="true" />
                <span className="text-sm">Mon-Sun: 7am - 10pm</span>
              </li>
            </ul>
          </div>
        </div>
