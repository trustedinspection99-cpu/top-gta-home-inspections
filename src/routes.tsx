...
// Generate dynamic blog routes with getStaticPaths
const blogChildRoutes: RouteRecord[] = blogPostsData.map((post) => ({
  path: post.slug,
  element: <BlogPost />,
}));
...
export const routes: RouteRecord[] = [
  {
    ...
    children: [
      ...
      { path: 'blog/:slug', element: <BlogPost />, getStaticPaths: () => blogPostsData.map(p => `blog/${p.slug}`) },
