...
export const blogPostsData: BlogPost[] = [
  {
    ...
    metaTitle: "First-Time Home Buyer Inspection Guide | ASADS Toronto",
    metaDescription: "Complete guide for first-time home buyers on what to expect during a home inspection. Learn what inspectors look for and how to prepare in Toronto & GTA.",
  ...
  },
  {
    ...
    metaTitle: "10 Common Home Inspection Issues in Toronto | ASADS",
    metaDescription: "Discover the most frequently found problems during home inspections in Toronto. From foundation cracks to outdated electrical systems, learn what to watch for.",
  ...
  },
  {
    ...
    metaTitle: "Winter Home Maintenance Checklist Toronto | ASADS",
    metaDescription: "Prepare your home for harsh Canadian winters with our comprehensive maintenance checklist. Prevent costly repairs and stay warm in Toronto.",
  ...
  },
  {
    ...
    metaTitle: "Mold Prevention Tips for Toronto Homes | ASADS",
    metaDescription: "Practical tips to prevent mold growth in your home. Learn about moisture control, ventilation, and early warning signs in Toronto homes.",
  ...
  },
  {
    ...
    metaTitle: "New Construction Home Inspection Guide | ASADS Toronto",
    metaDescription: "Why you need a professional inspection even on brand new homes. Learn about builder deficiencies and Tarion warranty coverage in Ontario.",
  ...
  },
  {
    ...
    metaTitle: "Condo Inspection Guide Toronto | ASADS",
    metaDescription: "Condo inspections differ from house inspections. Learn what's covered, the importance of status certificates, and common condo issues in Toronto.",
