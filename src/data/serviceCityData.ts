...
export const serviceDefinitions: ServiceDef[] = [
  ...
  },
  {
    ...
    price: "From $199",
    duration: "1–2 Hours",
    metaTitleTemplate: "WETT Inspection {city} | Certified Inspector | ASADS",
    metaDescTemplate:
    ...
    faqs: [
      { q: "What is a WETT inspection?", a: "A WETT inspection is a certified safety assessment of wood-burning heating appliances — fireplaces, wood stoves, fireplace inserts, and chimneys — conducted by a WETT-certified inspector. WETT stands for Wood Energy Technology Transfer, the Canadian organization that sets standards and certifies inspectors for wood-burning systems. In {city} and across Ontario, a WETT inspection assesses your entire system against CSA B365 standards, covering the appliance condition, chimney flue liner, clearances to combustibles, creosote buildup, chimney cap, and hearth dimensions. The inspection results in a formal WETT certificate required by most Ontario home insurers before they will issue or renew coverage on a property with a wood-burning appliance." },
